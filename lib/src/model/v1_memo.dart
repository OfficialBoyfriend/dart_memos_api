...
///
/// Properties:
/// * [name] - The name of the memo. Format: memos/{id} id is the system generated id.
...
/// * [parent] 
@BuiltValue()
abstract class V1Memo implements Built<V1Memo, V1MemoBuilder> {
  ...
  factory V1Memo([void updates(V1MemoBuilder b)]) = _$V1Memo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1MemoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1Memo> get serializer => _$V1MemoSerializer();
}

class _$V1MemoSerializer implements PrimitiveSerializer<V1Memo> {
  @override
  final Iterable<Type> types = const [V1Memo, _$V1Memo];

  @override
  final String wireName = r'V1Memo';
