...
part of 'v1_memo.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$V1Memo extends V1Memo {
  @override
  final String? name;
  @override
  final String? uid;
  ...
  factory _$V1Memo([void Function(V1MemoBuilder)? updates]) =>
      (new V1MemoBuilder()..update(updates))._build();
  ...
  @override
  V1Memo rebuild(void Function(V1MemoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  V1MemoBuilder toBuilder() => new V1MemoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is V1Memo &&
        name == other.name &&
        uid == other.uid &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'V1Memo')
          ..add('name', name)
          ..add('uid', uid)
...
class V1MemoBuilder implements Builder<V1Memo, V1MemoBuilder> {
  _$V1Memo? _$v;
  ...
  V1MemoBuilder() {
    V1Memo._defaults(this);
  }

  V1MemoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
      _uid = $v.uid;
  ...
  @override
  void replace(V1Memo other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$V1Memo;
  }

  @override
  void update(void Function(V1MemoBuilder)? updates) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'V1Memo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
